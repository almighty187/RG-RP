...
hook OnGameModeInit() {
	...
	// VIP Famed Dedicated perk
    CreateDynamic3DTextLabel("To change your number type /vipnum",COLOR_TWPURPLE,2549.548095, 1404.047729, 7699.584472+0.6,4.0); // LS VIP
    CreateDynamic3DTextLabel("To change your number type /vipnum",COLOR_TWGREEN,1832.6000, 1375.1700, 1464.4600+0.6,4.0);//
    CreateDynamic3DTextLabel("Type /travel\nTo exit the VIP garage with your vehicle",COLOR_TWPURPLE,-4429.944824, 905.032470, 987.078186+0.5,13.0);// LS VIP garage travel
    CreateDynamic3DTextLabel("/viplocker\nTo open the VIP locker.",COLOR_TWPURPLE,2555.747314, 1404.106079, 7699.584472+0.6,4.0);/// LS VIP locker
	CreateDynamic3DTextLabel("/viplocker\nTo open the VIP locker.",COLOR_TWGREEN,1832.0533, 1380.7281, 1464.3822+0.6,4.0);/// LV Main VIP locker
    CreateDynamic3DTextLabel("/viplocker\nTo open the VIP locker.",COLOR_TWGREEN,772.4844, 1715.7213, 1938.0391+0.6,4.0);/// LV Plat VIP locker
	...
	CreateDynamic3DTextLabel("/buytoys\n To buy some accessories.",COLOR_TWPURPLE,2561.3279, 1404.0374, 7699.5845+0.6,4.0); // LS VIP
