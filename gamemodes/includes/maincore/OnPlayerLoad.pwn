...
public OnPlayerLoad(playerid)
{
	...
	if( PlayerInfo[playerid][pPermaBanned] == 3 || PlayerInfo[playerid][pBanned] >= 1 )
	{
		...
		SendClientMessage(playerid, COLOR_RED, "Your account is banned! You can appeal this at http://forum.rg-rp.net");
	...
	{
		ShowPlayerDialogEx(playerid, DIALOG_DISABLED, DIALOG_STYLE_MSGBOX, "Account Disabled - Visit http://forum.rg-rp.net", "Your account has been disabled as it has been inactive for more than six months.\nPlease visit the forums and post an Administrative Request to begin the process to reactivate your account.", "Okay", "");
	...
	SendClientMessageEx(playerid, COLOR_RG, GlobalMOTD);
	...
	if(PlayerInfo[playerid][pInt] > 1 || PlayerInfo[playerid][pVW] > 1)
	{
