	...
	switch(stage)
	{
		case 0:
		{
			if(betaserver == 0) {
				...
				strcat(szMiscArray, "\t{F69500}Website{FFFFFF}: rg-rp.org - Sign up on our forums and interact with the community!\n");
		...
		case 3:
		{
			...
			strcat(szMiscArray, "Some groups allow you to apply to join them once you meet certain requirements! Check out all the groups at forum.rg-rp.org.");
			strcat(szMiscArray, "\n\n\n{FFFFFF}_______________________________________________________________________________________________________________________________________________________");
