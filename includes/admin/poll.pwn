...
hook OnDialogResponse(playerid, dialogid, response, listitem, inputtext[]) {
	...
	switch(dialogid) {
		...
		case DIALOG_POLLS_EDIT: {
			...
			switch(listitem) {
				case 0: ShowPlayerDialogEx(playerid, DIALOG_POLLS_QUESTION, DIALOG_STYLE_INPUT, "RG-RP Polls | Edit Question", "Please formulate a question for this poll", "Enter", "Cancel");
				case 1: {
					...
					ShowPlayerDialogEx(playerid, DIALOG_POLLS_OPTIONS, DIALOG_STYLE_LIST, "RG-RP Polls | Edit Options", szMiscArray, "Edit", "Cancel");
				}
				case 2: ShowPlayerDialogEx(playerid, DIALOG_POLLS_TYPE, DIALOG_STYLE_LIST, "RG-RP | Polls", "All\nFactions\nGangs\nBusiness\nVIP", "Enter", "Cancel");
				case 3: ShowPlayerDialogEx(playerid, DIALOG_POLLS_HOURS, DIALOG_STYLE_INPUT, "RG-RP | Polls", "Enter the minimum amount of playing hours to be able to cast a vote.", "Enter", "Cancel");
				case 4: {
		...
		case DIALOG_POLLS_OPTIONS: {
			...
			ShowPlayerDialogEx(playerid, DIALOG_POLLS_OPTIONS2, DIALOG_STYLE_INPUT, "RGP Polls | Edit", "Please enter an option", "Enter", "Cancel");
		}
...
public Poll_OnGetVotes(playerid) {
	...
	ShowPlayerDialogEx(playerid, DIALOG_NOTHING, DIALOG_STYLE_TABLIST_HEADERS, "RG-RP | Poll Results", szMiscArray, "OK", "");
	return 1;
}
...
CMD:poll(playerid, params[]) {
	...
	if(arrPolls[pol_bActive]) {
		...
		ShowPlayerDialogEx(playerid, DIALOG_POLLS_VOTE, DIALOG_STYLE_LIST, "RG-RP | Poll", szMiscArray, "Vote", "Cancel");
	}
...
CMD:editpoll(playerid, params[]) {
	...
	ShowPlayerDialogEx(playerid, DIALOG_POLLS_EDIT, DIALOG_STYLE_LIST, "RG-RP Polls | Edit", szMiscArray, "Select", "Cancel");
	return 1;
}
