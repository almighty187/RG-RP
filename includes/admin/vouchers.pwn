			...
			if(response)
			{
				...
				switch(listitem)
				{
					...
					case 4: // Restricted Car Voucher
					{
						...
						if(!IsPlayerInDynamicArea(playerid, NGGShop) && GetPlayerVirtualWorld(playerid) != 1) return SendClientMessageEx(playerid, COLOR_GRAD2, "You must be at RG-RP shop to redeem this voucher.");
