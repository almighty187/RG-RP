...
{
	if(PlayerInfo[playerid][pWRestricted] || PlayerInfo[playerid][pConnectHours] < 1) return SendClientMessageEx(playerid, COLOR_GRAD1, "You cannot use this command while having a weapon restriction.");
